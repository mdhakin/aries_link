...
void drive_update(drive_state_t* current, const drive_state_t* target,
                  const drive_ramp_config_t* config);

void drive_mix(const drive_state_t* state, const drive_limits_t* limits, drive_output_t* output);
